...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [128 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12762528; uint32_t buffer_offset
	}, ; 125: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12934048; uint32_t buffer_offset
	}, ; 126: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2024960, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12956608; uint32_t buffer_offset
	} ; 127: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14981568, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14981568 x i8] zeroinitializer, align 1
